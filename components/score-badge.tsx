...
export function ScoreBadge({ score, className }: { score: number | null; className?: string }) {
  if (score === null) {
    return (
      <div className={cn("inline-flex items-center justify-center rounded-md border border-muted-foreground/20 bg-muted/50 px-3 py-1.5", className)}>
  ...
  return (
    <div className={cn("inline-flex items-center justify-center rounded-md border px-3 py-1.5", bgClasses, colourClasses, className)}>
